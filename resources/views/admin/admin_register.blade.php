    ...
    <body id="page-top">
        ...
        <div class="preloader">
         ...
         <div class="wrapper without_header_sidebar">
          ...
          <input type="text" class="form-control" name="name" autocomplete="name" placeholder="Full Name">


                            </div>
              <div class="form-group icon_parent">
                                <label for="email">E-mail</label>
         <input type="email" class="form-control" name="email" required autocomplete="email" placeholder="Email Address">
                        ...
                        <div class="footer">
                            <p>Copyright &copy; {{ date("Y") }} <a href="https://passivedesk.com/">Passive Desk</a>. All rights reserved.</p>
                        </div>
                    </div>
                </div>
            </div><!--/ content wrapper -->
